...
var deltaT_01 = ee.Image("users/username/projectfolder/5_15cm/deltaT_01/deltaT_01_Bootstrapped_MultibandImage").select("deltaT_01_Predicted");
var deltaT_02 = ee.Image("users/username/projectfolder/5_15cm/deltaT_02/deltaT_02_Bootstrapped_MultibandImage").select("deltaT_02_Predicted");
var deltaT_03 = ee.Image("users/username/projectfolder/5_15cm/deltaT_03/deltaT_03_Bootstrapped_MultibandImage").select("deltaT_03_Predicted");
var deltaT_04 = ee.Image("users/username/projectfolder/5_15cm/deltaT_04/deltaT_04_Bootstrapped_MultibandImage").select("deltaT_04_Predicted");
var deltaT_05 = ee.Image("users/username/projectfolder/5_15cm/deltaT_05/deltaT_05_Bootstrapped_MultibandImage").select("deltaT_05_Predicted");
var deltaT_06 = ee.Image("users/username/projectfolder/5_15cm/deltaT_06/deltaT_06_Bootstrapped_MultibandImage").select("deltaT_06_Predicted");
var deltaT_07 = ee.Image("users/username/projectfolder/5_15cm/deltaT_07/deltaT_07_Bootstrapped_MultibandImage").select("deltaT_07_Predicted");
var deltaT_08 = ee.Image("users/username/projectfolder/5_15cm/deltaT_08/deltaT_08_Bootstrapped_MultibandImage").select("deltaT_08_Predicted");
var deltaT_09 = ee.Image("users/username/projectfolder/5_15cm/deltaT_09/deltaT_09_Bootstrapped_MultibandImage").select("deltaT_09_Predicted");
var deltaT_10 = ee.Image("users/username/projectfolder/5_15cm/deltaT_10/deltaT_10_Bootstrapped_MultibandImage").select("deltaT_10_Predicted");
var deltaT_11 = ee.Image("users/username/projectfolder/5_15cm/deltaT_11/deltaT_11_Bootstrapped_MultibandImage").select("deltaT_11_Predicted");
var deltaT_12 = ee.Image("users/username/projectfolder/5_15cm/deltaT_12/deltaT_12_Bootstrapped_MultibandImage").select("deltaT_12_Predicted");


var deltaT_5_15cm_IC = ee.ImageCollection.fromImages([
...
var deltaT_annual_5_15cm = deltaT_5_15cm_IC.reduce(ee.Reducer.mean()).rename("5_15cm_deltaT_annual")


// DeltaT Max
var deltaT_Max_01 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_01/deltaT_Max_01_Bootstrapped_MultibandImage").select("deltaT_Max_01_Predicted");
var deltaT_Max_02 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_02/deltaT_Max_02_Bootstrapped_MultibandImage").select("deltaT_Max_02_Predicted");
var deltaT_Max_03 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_03/deltaT_Max_03_Bootstrapped_MultibandImage").select("deltaT_Max_03_Predicted");
var deltaT_Max_04 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_04/deltaT_Max_04_Bootstrapped_MultibandImage").select("deltaT_Max_04_Predicted");
var deltaT_Max_05 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_05/deltaT_Max_05_Bootstrapped_MultibandImage").select("deltaT_Max_05_Predicted");
var deltaT_Max_06 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_06/deltaT_Max_06_Bootstrapped_MultibandImage").select("deltaT_Max_06_Predicted");
var deltaT_Max_07 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_07/deltaT_Max_07_Bootstrapped_MultibandImage").select("deltaT_Max_07_Predicted");
var deltaT_Max_08 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_08/deltaT_Max_08_Bootstrapped_MultibandImage").select("deltaT_Max_08_Predicted");
var deltaT_Max_09 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_09/deltaT_Max_09_Bootstrapped_MultibandImage").select("deltaT_Max_09_Predicted");
var deltaT_Max_10 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_10/deltaT_Max_10_Bootstrapped_MultibandImage").select("deltaT_Max_10_Predicted");
var deltaT_Max_11 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_11/deltaT_Max_11_Bootstrapped_MultibandImage").select("deltaT_Max_11_Predicted");
var deltaT_Max_12 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Max_12/deltaT_Max_12_Bootstrapped_MultibandImage").select("deltaT_Max_12_Predicted");

var deltaT_Max_5_15cm_IC = ee.ImageCollection.fromImages([
...
var deltaT_Max_annual_5_15cm = deltaT_Max_5_15cm_IC.reduce(ee.Reducer.mean()).rename("5_15cm_deltaT_Max_annual")

// DeltaT Min
var deltaT_Min_01 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_01/deltaT_Min_01_Bootstrapped_MultibandImage").select("deltaT_Min_01_Predicted");
var deltaT_Min_02 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_02/deltaT_Min_02_Bootstrapped_MultibandImage").select("deltaT_Min_02_Predicted");
var deltaT_Min_03 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_03/deltaT_Min_03_Bootstrapped_MultibandImage").select("deltaT_Min_03_Predicted");
var deltaT_Min_04 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_04/deltaT_Min_04_Bootstrapped_MultibandImage").select("deltaT_Min_04_Predicted");
var deltaT_Min_05 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_05/deltaT_Min_05_Bootstrapped_MultibandImage").select("deltaT_Min_05_Predicted");
var deltaT_Min_06 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_06/deltaT_Min_06_Bootstrapped_MultibandImage").select("deltaT_Min_06_Predicted");
var deltaT_Min_07 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_07/deltaT_Min_07_Bootstrapped_MultibandImage").select("deltaT_Min_07_Predicted");
var deltaT_Min_08 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_08/deltaT_Min_08_Bootstrapped_MultibandImage").select("deltaT_Min_08_Predicted");
var deltaT_Min_09 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_09/deltaT_Min_09_Bootstrapped_MultibandImage").select("deltaT_Min_09_Predicted");
var deltaT_Min_10 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_10/deltaT_Min_10_Bootstrapped_MultibandImage").select("deltaT_Min_10_Predicted");
var deltaT_Min_11 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_11/deltaT_Min_11_Bootstrapped_MultibandImage").select("deltaT_Min_11_Predicted");
var deltaT_Min_12 = ee.Image("users/username/projectfolder/5_15cm/deltaT_Min_12/deltaT_Min_12_Bootstrapped_MultibandImage").select("deltaT_Min_12_Predicted");

var deltaT_Min_5_15cm_IC = ee.ImageCollection.fromImages([
...
var deltaT_Min_annual_5_15cm = deltaT_Min_5_15cm_IC.reduce(ee.Reducer.mean()).rename("5_15cm_deltaT_Min_annual")
...
Export.image.toAsset({
	...
	description: 'soil_bioclim_export_5_15cm',
	assetId: 'users/username/projectfolder/soil_bioclim/SBIO_v1_5_15cm',
  crs: "EPSG:4326",
...
Export.image.toDrive({
	...
	description: 'SBIO1_5_15cm_Annual_Mean_Temperature',
...
Export.image.toDrive({
	...
	description: 'SBIO4_5_15cm_Temperature_Seasonality',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
...
Export.image.toDrive({
	...
	description: 'SBIO5_5_15cm_MaxT_warmestMonth_5km',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
...
Export.image.toDrive({
	...
	description: 'SBIO6_5_15cm_MinT_coldestMonth_5km',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
...
Export.image.toDrive({
	...
	description: 'SBIO7_5_15cm_annual_range_5km',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
...
Export.image.toDrive({
	...
	description: 'SBIO3_5_15cm_Isothermality_5km',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
...
Export.image.toDrive({
	...
	description: 'SBIO2_5_15cm_mean_diurnal_range_5km',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
...
Export.image.toDrive({
	...
	description: 'SBIO8_5_15cm_meanT_wettestQ_5km',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
...
Export.image.toDrive({
	...
	description: 'SBIO9_5_15cm_meanT_driestQ_5km',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
...
Export.image.toDrive({
	...
	description: 'SBIO10_5_15cm_meanT_warmestQ_5km',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
...
Export.image.toDrive({
	...
	description: 'SBIO11_5_15cm_meanT_coldestQ_5km',
	folder:'soil_temperature',
  crs: "EPSG:4326",
  crsTransform: [0.04166666666666667,0,-180,0,-0.04166666666666667,90],
	region: unboundedGeo,
